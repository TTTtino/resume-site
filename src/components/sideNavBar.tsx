...
const NavElement = (props: NavElementProps) => {
  return (
    <li
      className={`mx-2 bg-white rounded-md  md:w-64 ${props.active ? 'text-secondary-500 bg-opacity-75 font-extrabold' : 'text-white/80 bg-opacity-0 hover:bg-opacity-30'}`}
    >
      <Link to={props.info.href} className="block w-full h-full p-3">
