...
<Link href="https://ttttino.itch.io/eidolon">
    <a className=" flex flex-col items-center justify-center bg-rose-600 rounded-md shadow-sm hover:shadow-md hover:scale-105 ">
        <FaItchIo className="h-10 w-10 mt-1" />
